    ...
    return (
        <div className="container">
            <div className="row">
                ...
                <img src="./public/img/1.jpg" className="img-fluid" alt="Reserva"/>
                </div>
            ...
            <div className="row">
                ...
                <div className="col-md-6">
                    <img src="./public/img/2.jpg" className="img-fluid" alt="Saber más"/>
                </div>
            </div>
            <div className="row">
                <div className="col-md-6">
                    <img src="./public/img/3.jpg" className="img-fluid" alt="Ver más"/>
                </div>
                <div className="col-md-6 p-5">
                    <h2>Haz tu reserva</h2>
                    <p>Disfruta de la experiencia única de Hamburguesa Nostra. Reserva tu mesa de forma fácil y rápida en tu restaurante favorito.</p>
